...
import {
    ...
    Compass, Leaf, Wallet, ChevronRight, Thermometer, Droplets, Send, MessageCircle, Zap, Search, X
} from 'lucide-react';
...
type TabType = 'home' | 'explore' | 'planner' | 'wallet' | 'safety' | 'profile';
            ...
            >
                ...
                <motion.div variants={item} className="grid grid-cols-4 gap-3">
                    {[
                        ...
                        { icon: Wallet, label: 'Budget', color: 'from-amber-500 to-orange-500', emoji: '💰', tab: 'wallet' as TabType },
                        { icon: Shield, label: 'Safety', color: 'from-red-500 to-pink-500', emoji: '🛡️', tab: 'safety' as TabType },
                    ].map((action, i) => (
                        <motion.div
                            key={i}
